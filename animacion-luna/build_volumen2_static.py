...
W, H, FPS = 1280, 720, 30
import os
AUDIO = '/tmp/luna/v2_audio.m4a'
OUT = os.environ.get('OUT', '/mnt/documents/alunizaje_luna_volumen2_letras_quietas.mp4')
# tiempos de inicio de cada pantalla, tomados del render original
STARTS = [0.15, 3.8, 8.9, 13.9, 20.4, 26.4, 30.3, 36.6, 42.5, 48.2,
          52.8, 57.1, 60.5, 64.4, 73.4, 78.7, 84.4, 86.7]
DUR = 96.8
